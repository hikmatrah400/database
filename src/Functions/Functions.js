...
export const CheckBoxClick = (state, setState, id, DeleteObj, updateData) => {
  ...
  if (selectedIndex === -1) {
    ...
    if (updateData !== undefined) UpdateObj(updateData, id, true);
  } else if (selectedIndex === 0) {
    newSelected = newSelected.concat(state.slice(1));
    UpdateObj(DeleteObj, id, false);
    if (updateData !== undefined) UpdateObj(updateData, id, false);
