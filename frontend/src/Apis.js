...
export const expenseApi = `${path}/expense`;
export const historyApi = `${path}/history`;

export const accountLoginApi = `${path}/loginform`;
export const lockDatabaseApi = `${path}/lockdatabase`;
